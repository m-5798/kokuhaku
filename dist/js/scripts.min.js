...
if(void 0===Site){var Site={};!function(t,a){"use strict";window.document;t.getDevice=function(){var t=navigator.userAgent;return 0<t.indexOf("iPhone")||0<t.indexOf("Android")&&0<t.indexOf("Mobile")?"sp":0<t.indexOf("iPad")||0<t.indexOf("Android")?"tablet":"other"},t.anchorScroll=function(){$('a[href^="#"]').click(function(){var t=400,a=$(this).attr("href"),e=$("#"==a||""==a?"html":a).offset().top-70;return"#lede"===a&&(t=4e3,e+=70),$("body, html").animate({scrollTop:e},t,"swing"),!1})},t.toggleInfo=function(){var t=$(".p-information"),a=$("[data-kkhk-toggle]");a.on("click",function(){t.toggleClass("p-information-open")})},t.scrollOut=function(){var a="[data-kkhk-logo]",e="[data-kkhk-sideicons]",n="-show";$.each(["[data-kkhk-lede1]","[data-kkhk-lede3]","[data-kkhk-lede4]","[data-kkhk-lede5]","[data-kkhk-lede6]","[data-kkhk-business-h2_1]","[data-kkhk-business-h2_2]","[data-kkhk-works-h1]","[data-kkhk-member-h1]","[data-kkhk-member-h2_1]","[data-kkhk-member-h2_2]","[data-kkhk-member-h2_3]","[data-kkhk-member-h2_4]"],function(t,a){var e=$(a).attr("class")+n;ScrollOut({targets:a,once:!0,onShown:function(t){$(t).addClass(e)}})}),ScrollOut({targets:"[data-kkhk-lede2]",once:!0,onShown:function(t){$(a).addClass($(a).attr("class")+n),$(t).addClass($(t).attr("class")+n)}}),ScrollOut({targets:"[data-kkhk-business-h1]",once:!0,onShown:function(t){$(e).addClass($(e).attr("class")+n),$(t).addClass($(t).attr("class")+n)}}),$("[data-kkhk-img]").each(function(){var a=$(this).attr("class")+n,t=$(this).offset().top-100;ScrollOut({targets:$(this),offset:t,once:!0,onShown:function(t){$(t).addClass(a)}})})}}(Site)}$(document).ready(function(){Site.anchorScroll(),Site.toggleInfo(),Site.scrollOut();new Rellax(".rellax")});