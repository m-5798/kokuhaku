...
if(void 0===Site){var Site={};!function(t,a){"use strict";window.document;t.getDevice=function(){var t=navigator.userAgent;return 0<t.indexOf("iPhone")||0<t.indexOf("Android")&&0<t.indexOf("Mobile")?"sp":0<t.indexOf("iPad")||0<t.indexOf("Android")?"tablet":"other"},t.anchorScroll=function(){$('a[href^="#"]').click(function(){var t=$(this).attr("href"),a=$("#"==t||""==t?"html":t).offset().top;return console.log(t),a="#lede"===t?a:a-70,$("body, html").animate({scrollTop:a},400,"swing"),!1})},t.toggleInfo=function(){var t=$(".p-information"),a=$("[data-kkhk-toggle]");a.on("click",function(){t.toggleClass("p-information-open")})},t.scrollOut=function(){var a="[data-kkhk-logo]",o="-show";$.each(["[data-kkhk-lede1]","[data-kkhk-lede3]","[data-kkhk-business-h1]","[data-kkhk-business-h2_1]","[data-kkhk-business-h2_2]","[data-kkhk-works-h1]","[data-kkhk-member-h1]","[data-kkhk-member-h2_1]","[data-kkhk-member-h2_2]","[data-kkhk-member-h2_3]","[data-kkhk-member-h2_4]"],function(t,a){var e=$(a).attr("class")+o;ScrollOut({targets:a,once:!0,onShown:function(t){$(t).addClass(e)}})}),ScrollOut({targets:"[data-kkhk-lede2]",once:!0,onShown:function(t){$(a).addClass($(a).attr("class")+o),$(t).addClass($(t).attr("class")+o)}}),$("[data-kkhk-img]").each(function(){var a=$(this).attr("class")+o,t=$(this).offset().top-100;ScrollOut({targets:$(this),offset:t,once:!0,onShown:function(t){$(t).addClass(a)}})})}}(Site)}$(document).ready(function(){Site.anchorScroll(),Site.toggleInfo(),Site.scrollOut();new Rellax(".rellax")});