...
if(void 0===Site){var Site={};!function(a,t){"use strict";window.document;a.getDevice=function(){var a=navigator.userAgent;return 0<a.indexOf("iPhone")||0<a.indexOf("Android")&&0<a.indexOf("Mobile")?"sp":0<a.indexOf("iPad")||0<a.indexOf("Android")?"tablet":"other"},a.anchorScroll=function(){$('a[href^="#"]').click(function(){var a=$(this).attr("href"),t=$("#"==a||""==a?"html":a).offset().top;return t-=70,$("body, html").animate({scrollTop:t},400,"swing"),!1})}}(Site)}$(document).ready(function(){Site.anchorScroll();var a=$(".p-information"),t=$("[data-kkhk-toggle]");t.on("click",function(){a.toggleClass("p-information-open")});var e="[data-kkhk-logo]",n="-show";$.each(["[data-kkhk-lede1]","[data-kkhk-lede3]","[data-kkhk-business-h1]","[data-kkhk-business-h2_1]","[data-kkhk-business-h2_2]","[data-kkhk-works-h1]","[data-kkhk-member-h1]","[data-kkhk-member-h2_1]","[data-kkhk-member-h2_2]","[data-kkhk-member-h2_3]","[data-kkhk-member-h2_4]"],function(a,t){var e=$(t).attr("class")+n;ScrollOut({targets:t,once:!0,onShown:function(){$(t).addClass(e)}})}),ScrollOut({targets:"[data-kkhk-lede2]",once:!0,onShown:function(a){$(e).addClass($(e).attr("class")+n),$(a).addClass($(a).attr("class")+n)}})});